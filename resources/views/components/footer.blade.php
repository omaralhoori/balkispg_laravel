...
<footer class="bg-[#15130b] border-t border-[#2a261a] pt-16 pb-8 px-4 md:px-10 lg:px-20">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col gap-6 max-w-sm">
                ...
                <div class="flex gap-4 flex-wrap">
                    @if($linkedinUrl && $linkedinUrl !== '#')
                        <a class="w-10 h-10 rounded-full bg-white/5 hover:bg-primary hover:text-black flex items-center justify-center transition-all duration-300 text-gold-dim" href="{{ $linkedinUrl }}" target="_blank" rel="noopener noreferrer" title="LinkedIn">
                    ...
                    @if($twitterUrl && $twitterUrl !== '#')
                        <a class="w-10 h-10 rounded-full bg-white/5 hover:bg-primary hover:text-black flex items-center justify-center transition-all duration-300 text-gold-dim" href="{{ $twitterUrl }}" target="_blank" rel="noopener noreferrer" title="Twitter">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if($instagramUrl && $instagramUrl !== '#')
                        <a class="w-10 h-10 rounded-full bg-white/5 hover:bg-primary hover:text-black flex items-center justify-center transition-all duration-300 text-gold-dim" href="{{ $instagramUrl }}" target="_blank" rel="noopener noreferrer" title="Instagram">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if($facebookUrl && $facebookUrl !== '#')
                        <a class="w-10 h-10 rounded-full bg-white/5 hover:bg-primary hover:text-black flex items-center justify-center transition-all duration-300 text-gold-dim" href="{{ $facebookUrl }}" target="_blank" rel="noopener noreferrer" title="Facebook">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if($youtubeUrl && $youtubeUrl !== '#')
                        <a class="w-10 h-10 rounded-full bg-white/5 hover:bg-primary hover:text-black flex items-center justify-center transition-all duration-300 text-gold-dim" href="{{ $youtubeUrl }}" target="_blank" rel="noopener noreferrer" title="YouTube">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if($snapchatUrl && $snapchatUrl !== '#')
                        <a class="w-10 h-10 rounded-full bg-white/5 hover:bg-primary hover:text-black flex items-center justify-center transition-all duration-300 text-gold-dim" href="{{ $snapchatUrl }}" target="_blank" rel="noopener noreferrer" title="Snapchat">
                    ...
                    @if($tiktokUrl && $tiktokUrl !== '#')
                        <a class="w-10 h-10 rounded-full bg-white/5 hover:bg-primary hover:text-black flex items-center justify-center transition-all duration-300 text-gold-dim" href="{{ $tiktokUrl }}" target="_blank" rel="noopener noreferrer" title="TikTok">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Bottom Bar -->
        <div class="pt-8 border-t border-[#2a261a] flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
